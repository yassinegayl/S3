...
export default class BucketInfo {
    ...
    * TODO: Add additional properties of replicationConfiguration
    */
    constructor(name, owner, ownerDisplayName, creationDate,
        ...
        if (replicationConfiguration) {
            assert.strictEqual(typeof replicationConfiguration, 'object');
            const { Role, Rules } = replicationConfiguration;
            ...
            Rules.forEach(rule => {
                ...
                assert.strictEqual(typeof Destination, 'object');
