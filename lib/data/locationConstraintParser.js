...
const proxyAddress = 'https://localhost:3128';
    ...
    Object.keys(config.locationConstraints).forEach(location => {
        ...
        if (locationObj.type === 'aws_s3') {
            if (process.env.CI_PROXY === 'true') {
                locationObj.details.https = true;
                locationObj.details.proxy = proxyAddress;
                locationObj.details.certFilePaths = {};
                locationObj.details.certFilePaths.key = '/Users/dorakorpar/squid.pem';
                locationObj.details.certFilePaths.cert = '/Users/dorakorpar/squid.pem';
            }
        ...
        if (locationObj.type === 'azure') {
            if (process.env.CI_PROXY === 'true') {
                ...
                locationObj.details.proxy = proxyAddress;
                locationObj.details.certFilePaths = {};
                locationObj.details.certFilePaths.key = '/Users/dorakorpar/test.key';
                locationObj.details.certFilePaths.cert = '/Users/dorakorpar/test.crt';
            }
