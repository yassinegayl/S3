...
function objectPutCopyPart(authInfo, request, sourceBucket,
    ...
    return async.waterfall([
        ...
        function goGetData(dataLocator, destBucketMD,
            ...
            console.log('dataLocator!!!', dataLocator);
                    ...
                    return data.get(part, passThrough, log, (err, stream) => {
                            ...
                            (err, partInfo) => {
                                ...
                                // part metadata
                                  ...
                                  partInfo.dataStoreType === 'azure') {
                                    ...
                                    console.log('INSIDE IF AZURE', partResult);
                        ...
                        log, (error, partRetrievalInfo, hashedStream) => {
                            ...
                            const partResult = {
                                ...
                                size: part.size,
                                numberSubParts:
                                partRetrievalInfo.numberSubParts,
                            };
                            locations.push(partResult);
                            return cb();
                        });
