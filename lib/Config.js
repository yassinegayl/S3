...
class Config {
    ...
    _getConfig() {
        ...
        assert(config.versioning && config.versioning.siteId,
                'config: siteId must be set for versioning to work');
        // throwing format error is on purpose
        this.versioning = JSON.parse(JSON.stringify(config.versioning));
